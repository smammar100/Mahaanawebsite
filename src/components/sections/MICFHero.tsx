...
const TAB_TO_SECTION_ID: Record<(typeof MICF_HERO_TABS)[number]["id"], string> = {
  overview: "micf-overview-section-heading",
  performance: "micf-performance-section-heading",
  portfolio: "micf-portfolio-section-heading",
  distribution: "micf-distributions-section-heading",
