...
export const styles = {
    secondary:
        "bg-white text-text-tertiary border border-surface-stroke shadow-sm ring-1 ring-surface-stroke ring-inset hover:bg-gray-100 hover:text-text-secondary disabled:shadow-none disabled:ring-gray-300 disabled:opacity-60",
    tertiary: "text-text-tertiary hover:bg-gray-100 hover:text-text-primary",
};
...
export const ButtonUtility = ({
    ...
    const content = (
        <Component
            ...
            {...props}
            className={cx(
                "group relative inline-flex h-max cursor-pointer items-center justify-center rounded-md p-1.5 transition duration-100 ease-linear focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-system-brand disabled:cursor-not-allowed disabled:text-gray-400",
                styles[color],
